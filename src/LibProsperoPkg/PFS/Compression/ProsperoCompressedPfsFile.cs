...
/// </summary>
public readonly struct ProsperoPfsBlock
{
...
public sealed class ProsperoCompressedPfsFile
{
    ...
    public IReadOnlyList<ProsperoPfsBlock> Blocks { get; private init; } = Array.Empty<ProsperoPfsBlock>();
    ...
    private static List<ProsperoPfsBlock> ReadBlocks(
        ReadOnlyMemory<byte> buffer,
        ReadOnlySpan<byte> span,
        Dictionary<int, (long Offset, long Size)> sections,
        long dataOffset)
    {
        var blocks = new List<ProsperoPfsBlock>();
        ...
        for (int i = 0; i < blockCount; i++)
        {
            ...
            blocks.Add(new ProsperoPfsBlock
            {
                Index = i,
